...
<reference>
@D:/Developer/Minecraft_bot/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Developer/Minecraft_bot/.opencode/get-shit-done/references/user-profiling.md` to load:
