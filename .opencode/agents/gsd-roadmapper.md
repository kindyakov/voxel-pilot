...
Reference full template: `D:/Developer/Minecraft_bot/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Developer/Minecraft_bot/.opencode/get-shit-done/templates/state.md`.
