...
Use template from `D:/Developer/Minecraft_bot/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/Developer/Minecraft_bot/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/Developer/Minecraft_bot/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
