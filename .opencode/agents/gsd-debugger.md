...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Developer/Minecraft_bot/.opencode
                  → checks D:/Developer/Minecraft_bot/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Developer/Minecraft_bot/.opencode/get-shit-done
                  → writes to D:/Developer/Minecraft_bot/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "D:/Developer/Minecraft_bot/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/Developer/Minecraft_bot/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/Developer/Minecraft_bot/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
