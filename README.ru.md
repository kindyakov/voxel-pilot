...
AI-бот для Minecraft на базе Mineflayer и XState. Бот подключается к серверу, строит детерминированный снимок состояния мира, запрашивает у модели одно следующее действие и выполняет его через иерархический автомат состояний.
